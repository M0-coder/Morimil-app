...
class MemoryOrganDatabaseMigrationTest {
    ...
    @Test
    fun migratesLegacyV1ToCurrentV9WithoutDroppingCapsules() {
    ...
    @Test
    fun migratesV4ToV9AndAcceptsGraphAndMigrationRows() {
    ...
    @Test
    fun migratesV3ToCurrentV9WithRecallScheduleRuntimeTable() {
