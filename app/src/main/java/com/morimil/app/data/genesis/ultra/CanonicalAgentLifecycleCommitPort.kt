...
internal class CanonicalAgentLifecycleCommitPort private constructor(
    ...
    override suspend fun ensureCommitted(
        ...
        require(command.operationType in AgentLifecycleProtocolTypes.CLOSED_REGISTRY) {
            "agent_lifecycle_operation_type_unsupported"
        }
        ...
        return requireNotNull(findVerified(command)) {
            "agent_lifecycle_canonical_event_missing_after_append"
    ...
    private fun CrossDatabaseCanonicalCommand.toAppendCommand(): CanonicalMemoryAppendCommand {
        return CanonicalMemoryAppendCommand(
            ...
            provenance = CanonicalMemoryProvenance(
                ...
                userConfirmed = requiresUserConfirmation(operationType),
    ...
    private fun expectedProvenance(command: CrossDatabaseCanonicalCommand): String {
        return CrossDatabaseOperationIdentity.canonicalJson(
            mapOf(
                ...
                "user_confirmed" to requiresUserConfirmation(command.operationType)
            )
        )
    }
    ...
    private fun requiresUserConfirmation(operationType: String): Boolean {
        return operationType in setOf(
    ...
    internal companion object {
        ...
        ): CanonicalAgentLifecycleCommitPort = CanonicalAgentLifecycleCommitPort(
            appendText = appendText,
            readVerifiedSnapshot = readVerifiedSnapshot
        )

        const val ACTOR = "agent_lifecycle_protocol"
        ...
        const val CLASSIFICATION = "durable_agent_lifecycle_transition"
