...
internal object MorimilDatabaseMigrations {
    ...
    val MIGRATION_9_10 = migration(9, 10) { db ->
        ...
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS index_genesis_ultra_birth_commit_birthId ON genesis_ultra_birth_commit(birthId)")
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS index_genesis_ultra_birth_commit_instanceId ON genesis_ultra_birth_commit(instanceId)")
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS index_genesis_ultra_birth_commit_journalId ON genesis_ultra_birth_commit(journalId)")
        db.execSQL(
            """
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS index_genesis_ultra_birth_artifacts_slotId_artifactKind ON genesis_ultra_birth_artifacts(slotId, artifactKind)")
        db.execSQL(
            """
        ...
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS index_genesis_ultra_birth_journal_journalId_sequence ON genesis_ultra_birth_journal(journalId, sequence)")
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS index_genesis_ultra_birth_journal_journalDigest ON genesis_ultra_birth_journal(journalDigest)")
    }
    ...
    val MIGRATION_10_11 = migration(10, 11) { db ->
        ...
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS index_genesis_ultra_memory_events_eventId ON genesis_ultra_memory_events(eventId)")
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS index_genesis_ultra_memory_events_eventHash ON genesis_ultra_memory_events(eventHash)")
    }
