...
/** Exact canonical ensure adapter for BOOT-001. */
internal class CanonicalRuntimeBootstrapCommitPort private constructor(
    ...
    override suspend fun ensureCommitted(
        ...
        require(command.operationType == RuntimeBootstrapProtocolTypes.INITIALIZE) {
            "runtime_bootstrap_canonical_operation_unsupported"
        }
        ...
        return requireNotNull(findVerified(command)) {
            "runtime_bootstrap_canonical_event_missing_after_append"
    ...
    internal companion object {
        fun testing(
            ...
            return CanonicalRuntimeBootstrapCommitPort(
                appendText = appendText,
                readVerifiedSnapshot = readVerifiedSnapshot
            )
        }

        const val ACTOR = "runtime_bootstrap_protocol"
        ...
        const val CLASSIFICATION = "durable_runtime_bootstrap_transition"
