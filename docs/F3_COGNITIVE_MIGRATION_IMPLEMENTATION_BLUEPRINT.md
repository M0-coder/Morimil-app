...
- Gate: `STOP_S5=CLOSED`.
- Integrated scope of this blueprint: `COG-001` through `COG-004`; ADR-0002 also governs integrated ORCH-002..004, AGENT-001..006 and BOOT-001.
...
- no database, Android process, GitHub state, model, provider, agent worker, BOOT projection, or Guardian action becomes identity or canonical-memory authority;
...
ProjectVault remains separate. PR #172 integrated ORCH-002..004 under ADR-0002, PR #174 integrated AGENT-001..006, and PR #176 integrated BOOT-001 under the same ADR without changing the COG mapping documented here.

Remaining F3.2 work is `RECALL-001`, `ORCH-001`, `REST-001/002`, and health convergence. F3.3 legacy removal remains open.
...
COG remains covered by unit, lint, APK, CodeQL, SBOM, Reference Checks and managed-device evidence. Broader ADR evidence now also includes ORCH, AGENT and BOOT exact-head validation, but that does not alter the COG mapping.
...
F3_2_BOUNDED_SCOPE=CLOSED_FOR_PROJECTVAULT_COG_ORCH_AGENT_AND_BOOT_ONLY
RECALL_001=OPEN
ORCH_001=OPEN
REST_001_002=OPEN
